...
namespace Destructible2D.Examples
{
	...
	[HelpURL(D2dHelper.HelpUrlPrefix + "D2dTapToSpawn")]
	[AddComponentMenu(D2dHelper.ComponentMenuPrefix + "Tap To Spawn")]
	public class D2dTapToSpawn : MonoBehaviour
	{
		...
		public D2dInputManager.Trigger Controls = new D2dInputManager.Trigger(true, true, KeyCode.None);
		...
		private void DoSpawn(D2dInputManager.Finger finger, float twist)
		{
			// Prefab exists?
			if (Prefab != null)
			{
...
namespace Destructible2D.Examples
{
	...
	public class D2dTapToSpawn_Editor : D2dEditor
	{
