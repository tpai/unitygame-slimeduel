...
namespace Destructible2D.Examples
{
	...
	public class D2dPlayerCar : MonoBehaviour
	{
		...
		public D2dInputManager.Axis TurnControls = new D2dInputManager.Axis(1, false, D2dInputManager.AxisGesture.HorizontalPull, 0.01f, KeyCode.A, KeyCode.D, KeyCode.LeftArrow, KeyCode.RightArrow, 1.0f);

		/// <summary>The fingers/keys used to accelerate and reverse.</summary>
		public D2dInputManager.Axis MoveControls = new D2dInputManager.Axis(1, false, D2dInputManager.AxisGesture.VerticalPull, 0.01f, KeyCode.S, KeyCode.W, KeyCode.DownArrow, KeyCode.UpArrow, 1.0f);
		...
		[FSA("SteerAngleDampening")] public float SteerAngleDamping = 5.0f;
		...
		[FSA("DriveDampening")] public float DriveDamping = 5.0f;
		...
		protected virtual void Update()
		{
			...
			var steerFactor = D2dHelper.DampenFactor(SteerAngleDamping, Time.deltaTime);
			var driveFactor = D2dHelper.DampenFactor(     DriveDamping, Time.deltaTime);
...
namespace Destructible2D.Examples
{
	...
	public class D2dPlayerCar_Editor : D2dEditor
	{
