...
namespace Destructible2D.Examples
{
	...
	public class D2dPlayerSnake : MonoBehaviour
	{
		...
		public D2dInputManager.Axis HorizontalControls = new D2dInputManager.Axis(1, false, D2dInputManager.AxisGesture.HorizontalPull, 0.01f, KeyCode.A, KeyCode.D, KeyCode.LeftArrow, KeyCode.RightArrow, 1.0f);

		/// <summary>The fingers/keys used to move down and up.</summary>
		public D2dInputManager.Axis VerticalControls = new D2dInputManager.Axis(1, false, D2dInputManager.AxisGesture.VerticalPull, 0.01f, KeyCode.S, KeyCode.W, KeyCode.DownArrow, KeyCode.UpArrow, 1.0f);
...
namespace Destructible2D.Examples
{
	...
	public class D2dPlayerSnake_Editor : D2dEditor
	{
